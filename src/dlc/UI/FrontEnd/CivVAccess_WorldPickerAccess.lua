...
BaseMenu.install(ContextPtr, {
    ...
    items = {
        BaseMenuItems.Button({
            controlName = "DuelWorldSizeButton",
            textKey = "TXT_KEY_WORLD_DUEL",
            activate = function()
                DuelWorldSizeButtonClick()
            end,
        }),
        BaseMenuItems.Button({
            controlName = "TinyWorldSizeButton",
            textKey = "TXT_KEY_WORLD_TINY",
            activate = function()
                TinyWorldSizeButtonClick()
            end,
        }),
        BaseMenuItems.Button({
            controlName = "SmallWorldSizeButton",
            textKey = "TXT_KEY_WORLD_SMALL",
            activate = function()
                SmallWorldSizeButtonClick()
            end,
        }),
        BaseMenuItems.Button({
            controlName = "StandardWorldSizeButton",
            textKey = "TXT_KEY_WORLD_STANDARD",
            activate = function()
                StandardWorldSizeButtonClick()
            end,
        }),
        BaseMenuItems.Button({
            controlName = "LargeWorldSizeButton",
            textKey = "TXT_KEY_WORLD_LARGE",
            activate = function()
                LargeWorldSizeButtonClick()
            end,
        }),
        BaseMenuItems.Button({
            controlName = "HugeWorldSizeButton",
            textKey = "TXT_KEY_WORLD_HUGE",
            activate = function()
                HugeWorldSizeButtonClick()
            end,
        }),
    },
})
